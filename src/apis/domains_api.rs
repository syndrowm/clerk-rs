...
pub async fn add_domain(configuration: &configuration::ClerkConfiguration, add_domain_request: Option<crate::models::AddDomainRequest>) -> Result<crate::models::Domain, Error<AddDomainError>> {
...
pub async fn delete_domain(configuration: &configuration::ClerkConfiguration, domain_id: &str) -> Result<crate::models::DeletedObject, Error<DeleteDomainError>> {
    let local_var_configuration = configuration;
...
pub async fn list_domains(configuration: &configuration::ClerkConfiguration, ) -> Result<crate::models::Domains, Error<ListDomainsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_domain(configuration: &configuration::ClerkConfiguration, domain_id: &str, update_domain_request: crate::models::UpdateDomainRequest) -> Result<crate::models::Domain, Error<UpdateDomainError>> {
    let local_var_configuration = configuration;
